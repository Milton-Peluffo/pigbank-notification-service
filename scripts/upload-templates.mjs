 ...
 * Uso: node scripts/upload-templates.cjs
 */
...
const BUCKET_NAME = process.env.S3_BUCKET_NAME || "pig-bank-templates-email-notification-335014104150";
...
async function uploadTemplates() {
  ...
  try {
    ...
    console.log(`\n${uploadedCount}/${files.length} templates uploaded successfully\n`);
